function hitungLuas() {
    ...
    document.getElementById("sisi-luas").innerHTML = sisiLuas[0].value + " x " +
        sisiLuas[0].value;
    document.getElementById("output-luas").hidden = false;
}

function resetLuas() {
    var sisiLuas = document.getElementsByName("sisi-luas");
    sisiLuas[0].value = "";
    document.getElementById("output-luas").hidden = true;
}
...
function hitungKeliling() {
    ...
    document.getElementById("output-keliling").hidden = false;
}

function resetKeliling() {
    var sisiKeliling = document.getElementsByName("sisi-keliling");
    sisiKeliling[0].value = "";
    document.getElementById("output-keliling").hidden = true;
}
